        ...
        <div class="container">
            ...
            <nav class="menu">
                <ul class="ulmenu">
                    ...
                    <li class="limenu"><a class="amenu" href="./stats.php">STATS</a></li>
                </ul>
            </nav>
        </div>
        <script src="./javascript/data.js"></script> <!-- <p>JSON script call containing the cities data</p> -->
        <script src="./javascript/selection.js"></script> <!-- <p>Call of the Javascript script allowing to display the SVGs of the departments and to filter the choices</p> -->
    </header>
    <hr />
    <?php
    /*
